...
readwfs returns **unclassed tibbles with wk geometry**, not sf objects.
This keeps the dependency tree small and composable—you can use geos for
geometry operations, gdalraster for raster work, and dplyr for data wrangling.

If you need sf downstream:

```{r}
if (requireNamespace("sf", quietly = TRUE)) {
  parcels_sf <- sf::st_as_sf(parcels, sf_column_name = "geometry")
}
```
